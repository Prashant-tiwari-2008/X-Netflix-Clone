...
const EditPostModel = () => {
    ...
    const updatePost = async () => {
        ...
        await updateDoc(docRef, {
            ...
            content: editText ? editText : post.content,
            profileImg: session.user.image,
            timestamp: serverTimestamp(),
            image: imageFileUrl ? imageFileUrl : post.image,
        });
        setEditText('');
        setOpen(false);
                ...
                <Modal isOpen={open} onRequestClose={() => setOpen(false)} ariaHieApp={false}
                    ...
                    <div className='p-4'>
                        ...
                        <div className='w-full border-b-2'>
                            <span >Post : </span>
                            <textarea className="w-full border-none focus:ring-0 text-lg placeholder-gray-700 tracking-wide min-h-[60px] text-gray-700 outline-none p-1" maxLength="280" spellCheck="false" defaultValue={post.content}
                                onChange={(e) => {
                        ...
                        <div className='flex gap-4 justify-end'>
                            ...
                            <button className="bg-green-600 text-white py-2 px-3  rounded-lg font-bold shadow-md hover:brightness-95 disabled:opacity-50" onClick={() => updatePost()} disabled={uploadbuttonDisable}>Update Post</button>
                        </div>
                    </div>
                </Modal>
            )}
